    ...
    return (
        <footer className='footer2 bg-[#1d110e] text-[#f2dcb3] flex flex-col'>
            <div className='footer flex justify-around items-end h-20'>
                <a href='https://www.facebook.com/natalie.siagkrisseymour.1' target="_blank" rel="noreferrer"><FaFacebook className='mb-2 md:mb-0 text-5xl md:text-6xl md:ml-60 lg:ml-80 hover:opacity-80' /></a>
                <a href='https://anidifranco.com/' target="_blank" rel="noreferrer" className='md:-mb-2'><img className='ani-logo w-24 md:w-28 -rotate-1 hover:opacity-80' src='./footerLogo2.png'></img></a>
