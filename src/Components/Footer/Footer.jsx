...
function Footer() {
    return (
        <footer className='footer2 bg-[#1d110e] text-[#f2dcb3] flex flex-col'>
            <div className='footer flex justify-evenly items-end h-20'>
                <a href='https://www.youtube.com/' target="_blank" rel="noreferrer"><IoLogoYoutube className='mb-2 md:mb-0 text-5xl md:text-6xl hover:opacity-80' /></a>
                ...
                <a href='https://www.instagram.com/natshapednat/' target="_blank" rel="noreferrer"><FaInstagram className='mb-2 md:mb-0 text-5xl md:text-6xl hover:opacity-80' /></a>
            </div>
            <div>
