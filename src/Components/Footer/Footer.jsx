...
function Footer() {
    return (
        <footer className='footer2 bg-[#1d110e] text-[#f2dcb3] h-32 flex flex-col'>
            ...
            <div>
                <a href='https://immense-everglades-74554-f9bad473782a.herokuapp.com/' target="_blank" rel="noreferrer"><h4 className='description-text flex justify-end items-end mt-1 md:mt-0 mr-2 mb-1 text-[.85em] md:text-[1em]'>site designed and built by kris kurzawa</h4></a>
            </div>
        </footer>
