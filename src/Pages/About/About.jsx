    ...
    return (
        <main className='bg-[#c2b39c] border-b-[6px] border-[#a8957b]'>
            ...
            <article className='pb-5 mx-7 md:mx-10 text-xl md:text-2xl'>
                ...
                <h2 id='tips' className='about-header-text'>tips for playing ani</h2>
                <h3 className='about-sub-header-text'>tuning notation</h3>
                <h4 className='about-description-text'>
                ...
                <h4 id='therefore' className='about-description-text'>
                ...
                <h3 className='about-sub-header-text'>strings</h3>
                <h4 className='about-description-text'>
                ...
                <h3 className='about-sub-header-text'>
                    nails and picking
                </h3>
                <h4 className='about-description-text'>
                ...
                <DynamicsTable />
                <h2 id='acknowledgements' className='about-header-text'>
                    acknowledgements
                </h2>
                <h4 className='about-description-text mb-10'>
